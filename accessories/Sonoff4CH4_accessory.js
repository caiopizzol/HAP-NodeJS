...
var name = "Outlet1.4"; //accessory name
var sonoffUUID = "hap-nodejs:accessories:sonoff4CH4" + name; //change this to your preferences
var sonoffUsername = "1D:2D:31:44:5A:44";
var MQTT_NAME = 'sonoff_4chpro1' //MQTT topic that was set on the Sonoff firmware
...
//  password: 'raspberry', //enable only if you have authentication on your MQTT broker
  clientId: MQTT_NAME+'4Sonoff4CH'
};
var sonoffTopic = 'cmnd/'+MQTT_NAME+'/power4';
...
client.on('connect', function () {
  client.subscribe('stat/'+MQTT_NAME+'/POWER4')
});
